...
# Magyar + Szlovák női nevek adatbázisa (leggyakoribb ~700 név)
HUNGARIAN_FEMALE_NAMES = {
    # A-betűs női nevek
    "ada", "adél", "adela", "adéla", "adrien", "adriana", "adriána", "adrienn", "ágnes", "agata", 
    "agáta", "agota", "aisha", "alena", "alexa", "alexandra", "alíz", "alina", "alzbeta", "alžbeta", 
    "amanda", "amira", "ana", "anamária", "andrea", "aneta", "anežka", "anasztázia", "angela", 
    "angéla", "anikó", "anita", "anka", "anna", "annabella", "antónia", "apollónia", "aranka", 
    "ariana", "arianna", "arlette", "ashley", "asztrid", "atala", "aurora", "ava",
    # B-C betűs női nevek
    "babett", "barbara", "barbora", "beáta", "beata", "beatrix", "bella", "berta", "bianka", "blanka", 
    "boglárka", "borbála", "božena", "brigitta", "brigita", "carmen", "cecília", "cecilia", "cintia", 
    "cindy", "cleo", "csenge", "cynthia",
    # D-E betűs női nevek
    "dagmar", "dagmara", "dana", "daniela", "daniella", "darina", "dária", "debóra", "denisa", "denise", 
    "diána", "diana", "dina", "dominika", "donna", "dóra", "dorota", "dorina", "dorottya",
    "edina", "edita", "edit", "egina", "elaine", "elena", "elektra", "eleonóra", "eliana", "elisa", 
    "elisabeth", "eliska", "eliška", "elizabet", "eliza", "ella", "ellen", "elma", "elona", "elsa", 
    "elvira", "emese", "emília", "emilia", "emma", "emmanuella", "enikő", "erika", "erna", "ernesztina", 
    "eszter", "eta", "eugenia", "eulália", "eva", "éva", "evelin", "evelina", "evelína",
    # F-G betűs női nevek
    "fanni", "fanny", "fatima", "fatime", "felicia", "felícia", "fiona", "flóra", "flora", "franciska", 
    "franziska", "frida", "fruzsina",
    "gabi", "gabriela", "gabriella", "genovéva", "georgia", "gerda", "gitta", "gizela", "gizella", 
    "glória", "grace", "gréta", "greta", "gudrun",
    # H-I betűs női nevek
    "hajnalka", "hana", "hanna", "hedvig", "hedviga", "heidi", "hella", "helena", "helga", "henrieta", 
    "henrietta", "hilda",
    "ida", "ildikó", "ilka", "ilma", "ilona", "inez", "inola", "ibolya", "irena", "irén", "irina", 
    "iris", "irma", "isa", "isabel", "ivana", "iveta", "izabela", "izabella", "iza",
    # J-K betűs női nevek
    "jácinta", "jacinta", "jana", "jane", "janka", "jarmila", "jazmin", "jennifer", "jenny", "jessica", 
    "jindřiška", "jitka", "jocelyn", "johanna", "jolán", "jolana", "jolanda", "josephine", "joyce", 
    "judita", "judit", "judith", "julia", "júlia", "juliana", "julianna", "jusztina",
    "kamila", "kamilla", "karolina", "karolína", "karolin", "katarína", "katalin", "kata", "katica", 
    "katka", "karina", "katherine", "katie", "katrina", "katrína", "kendra", "kinga", "kira", "kitti", 
    "klára", "klara", "klaudia", "klementina", "kora", "kornélia", "kristína", "krista", "kristina", 
    "krisztina",
    # L-M betűs női nevek
    "lana", "laura", "laurencia", "lea", "léna", "lenka", "leona", "leonóra", "lili", "lilla", "liliána", 
    "lina", "linda", "livia", "lívia", "liza", "lora", "loretta", "lotti", "louisa", "lucia", "lúcia", 
    "lucie", "lucilla", "ludmila", "ludmilla", "luna", "lydia",
    "magdalena", "magdaléna", "magda", "magdolna", "maja", "mara", "marcela", "marcella", "margit", 
    "margaréta", "margarita", "mária", "maria", "marianna", "marika", "marina", "marion", "marita", 
    "markéta", "marlena", "marlene", "márta", "marta", "martina", "mary", "matilda", "maya", "melanie", 
    "melinda", "melissa", "mercédesz", "mia", "michaela", "michelle", "mikaela", "milada", "milena", 
    "milla", "mira", "miriam", "miranda", "mirjam", "miroslava", "moira", "monika", "mónika",
    # N-O betűs női nevek
    "nada", "nadežda", "nadina", "nadia", "nadzieja", "nancy", "naomi", "natalia", "natália", "nataša", 
    "natasa", "natascha", "natasha", "nelli", "nicole", "nikola", "nikol", "nikoleta", "nikolett", 
    "nina", "nóra", "noémi", "norina", "odett", "odetta", "olga", "olívia", "olivia", "orsolya", 
    "otília", "ottilia",
    # P-R betűs női nevek
    "pamela", "patricia", "patrícia", "paula", "paulina", "paulína", "pavla", "pavlína", "petra", 
    "petronella", "piroska", "priscilla",
    "radka", "ramóna", "rebeka", "regina", "réka", "renáta", "renata", "renáta", "rita", "roberta", 
    "romana", "rose", "roxána", "rozália", "rozina", "ruby", "ruth", "ružena",
    # S-betűs női nevek
    "sabina", "salome", "samantha", "sandra", "sára", "sara", "sarolta", "saskia", "selena", "selin", 
    "sena", "sheila", "silvia", "silvie", "simona", "sofia", "sona", "sonia", "sonja", "soňa", "sophie", 
    "stanislava", "stefánia", "štefánia", "stella", "stephanie", "susan", "susana", "susanna", "suzzana", 
    "svetlana", "szabina", "szandra", "szilvia", "szonja", "szófia",
    # T-V betűs női nevek
    "tali", "tama", "tamara", "tania", "táňa", "tara", "tatiana", "taťána", "tatjána", "tea", "teodóra", 
    "teréz", "tereza", "terézia", "tessa", "thea", "theodora", "theresa", "tiana", "timea", "tímea", 
    "tina", "toni", "trisha",
    "vada", "valentina", "valeria", "valéria", "vanesa", "vanessa", "vanda", "venice", "vera", "veronika", 
    "viera", "victoria", "viktória", "vilma", "viola", "violetta", "virginia", "vivien", "vivienne", 
    "vladimíra",
    # W-Z betűs női nevek
    "wendy", "wilhelmina", "yasmin", "yvette", "yvonne", "zara", "zdena", "zdenka", "zelma", "zita", 
    "zoé", "zoe", "zoltánné", "zora", "zsofia", "zsófia", "zsuzsanna", "zuzana",
}
